...
<html lang="en">
    <head>
        ...
        <title>Specimen Resquest Form</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        if(isset($_POST['submit'])){
         ...
         $query = $conn->query("INSERT INTO specimen_req_tbl(Book_Name, User_Name, Email, Category) VALUES ('$bname', '$uname', '$email', '$category')");
         $conn->close();
         if($query == true){
        ...
        <header style="background-color:black;" class=" py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">You can Request for a Specimen Here.</p>
                </div>
            </div>
        </header>
        <!-- Section-->
            ...
            <form method="POST">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <label for="name">
                                 Username</label>
                            <input type="text" class="form-control" id="name" placeholder="Enter Username" name="uname" required="required" />
                        </div>
                        <div class="form-group">
                        <label for="email">
                                Email</label>
